...
def print_results(results_dic, results_stats_dic, model,
    ...
    stats = results_stats_dic

    print('CNN Model: %s' % (model))
    ...
    print('%% Correct Dogs: %f' % (stats['pct_correct_dogs']))
    print('%% Correct Breed: %f' % (stats['pct_correct_breed']))
    print('%% Correct "Not-a" Dog: %f' % (stats['pct_correct_notdogs']))
    print('%% Match: %f' % (stats['pct_match']))


    if print_incorrect_dogs and (
        stats['n_correct_dogs'] + stats['n_correct_notdogs']
