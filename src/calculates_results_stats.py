...
def calculates_results_stats(results_dic):
    ...
    for key, data in results_dic.items():
        image_label, class_label, is_match, image_is_dog, class_is_dog = data
